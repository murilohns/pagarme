...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { complementary: @information.complementary, ddd: @information.ddd, member_id: @information.member_id, neighborhood: @information.neighborhood, phone_number: @information.phone_number, street: @information.street, street_number: @information.street_number, zipcode: @information.zipcode } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { complementary: @information.complementary, ddd: @information.ddd, member_id: @information.member_id, neighborhood: @information.neighborhood, phone_number: @information.phone_number, street: @information.street, street_number: @information.street_number, zipcode: @information.zipcode } }
